    ...
    <footer id="contact" className="bg-foreground text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* About */}
          <div>
            <h3 className="font-serif text-xl font-bold mb-4">{restaurant.name}</h3>
            <p className="text-white/80 leading-relaxed mb-4">{restaurant.description}</p>
          </div>
          ...
          {/* Map & Social */}
          <div>
            <h4 className="font-serif text-lg font-bold mb-4">Nous Trouver</h4>
